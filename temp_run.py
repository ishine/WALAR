...
if __name__ == '__main__':
    ...
    sentence = "Repeat this sentence: If Mr. Trump again wins the presidency, he might order that the federal cases brought by special counsel Jack Smith be dropped by the Justice Department, or even pardon himself to avoid trial. If Mr. Trump again wins the presidency, he might order that the federal cases brought by special counsel Jack Smith be dropped by the Justice Department, or even pardon himself to avoid trial."
