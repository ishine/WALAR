...
# TEMPLATE_DA = "Score the following translation from {source_lang} to {target_lang} on a continuous scale from 0 to 100, where a score of zero means \"no meaning preserved\" and score of one hundred means \"perfect meaning and grammar\". If the translation is not {target_lang}, you should give 0 to it. Please first check whether the translation is {target_lang} and then give your explanation, and finally give your score in \\boxed{{}}.\n\n{source_lang} source: \"{source_seg}\"\n{target_lang} translation: \"{target_seg}\"\n"
