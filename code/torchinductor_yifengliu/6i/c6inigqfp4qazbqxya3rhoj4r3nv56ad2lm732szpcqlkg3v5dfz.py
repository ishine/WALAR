...
# kernel path: /mnt/gemini/data1/yifengliu/qe-lr/code/torchinductor_yifengliu/ry/cry4uvpvzt6jiujd4hiq5o3stdmydn3kwqxl7bkvvmj6kwtnthbd.py
...
@triton_heuristics.pointwise(
    size_hints={'x': 8192}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*i32', 'out_ptr0': '*i64', 'out_ptr1': '*i1', 'ks0': 'i32', 'ks1': 'i32', 'ks2': 'i32', 'ks3': 'i32', 'ks4': 'i32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=3, multi_processor_count=84, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(3):
        ...
        triton_poi_fused_add_bitwise_and_bitwise_not_bitwise_or_ge_lt_mul_sub_0.run(arg1_1, buf0, buf1, s1, s2, s3, s4, s5, s0, stream=stream3)
        del arg1_1
    return (buf0, buf1, )
