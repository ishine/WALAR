...
# kernel path: /mnt/gemini/data1/yifengliu/qe-lr/code/torchinductor_yifengliu/nd/cnd64fp4n3uet3uqyzazyibeu7x5sxezwntluuwuimftfqiv55xj.py
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(2):
        ...
        triton_poi_fused_add_bitwise_and_bitwise_not_bitwise_or_ge_lt_mul_sub_0.run(arg1_1, buf0, buf1, s1, s2, s3, s4, s5, s0, stream=stream2)
        del arg1_1
    return (buf0, buf1, )
