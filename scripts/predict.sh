...
process_language_pairs() {
  ...
  case $data_name in
    ...
    "flores")
      ...
      # input_file_pattern="/mnt/gemini/data1/yifengliu/qe-lr/output/flores/nllb-200-1.3B"
      # input_file_pattern="/mnt/gemini/data1/yifengliu/qe-lr/output/flores/translategemma-4b-it"
      # input_file_pattern="/mnt/gemini/data1/yifengliu/qe-lr/output/flores/final/alpha20-gemma-8B-final_gemma_mix250-bsz1024"
      ...
      ;;
      "benchmax")
      input_file_pattern="/mnt/gemini/data1/yifengliu/BenchMAX/tasks/translation/output/final_alpha20-glotmax-8B-final_qwen_mix250-bsz1024/flores"
      # input_file_pattern="/mnt/gemini/data1/yifengliu/BenchMAX/tasks/translation/output/Qwen3-8B/flores"
      # input_file_pattern="/mnt/gemini/data1/yifengliu/BenchMAX/tasks/translation/output/alpha20-Qwen-8B-final_aya_mix250-bsz1024_global_step2000_hf/flores"
      ...
      # input_file_pattern="/mnt/gemini/data1/yifengliu/BenchMAX/tasks/translation/output/Qwen3-4B-Instruct-2507/flores"
      # input_file_pattern="/mnt/gemini/data1/yifengliu/BenchMAX/tasks/translation/output/alpha20-Qwen-4B-final_qwen_mix250-bsz1024_global_step1500_hf/flores"
      ...
      # input_file_pattern="/mnt/gemini/data1/yifengliu/BenchMAX/tasks/translation/output/llamax_sft/flores"
...
if [ $data_name == "afriMTE" ]; then
  ...
  if [ ${#tgt_list[@]} -eq 0 ]; then
    ...
    # 'ind' 'gle' 'ita' 'jpn' 'jav' 'kea' 'kam' 'kan' 'kaz' 'khm' 'kor' 'kir' 'lao' 'lav' 'lin' 'lit' 'luo' 'ltz' 'mkd' 
    # 'msa' 'mal' 'mlt' 'mri' 'mar' 'mon' 'nob' 'npi' 'nso' 'nya' 'oci' 'ory' 'orm' 'pus' 'fas' 'pol' 'por' 'pan' 'ron' 'rus' 
    # 'srp' 'sna' 'snd' 'slk' 'slv' 'som' 'ckb' 'spa' 'swh' 'swe' 'tgk' 'tam' 'tel' 'tha' 
    # 'tur' 'ukr' 'umb' 'urd' 'uzb' 'vie' 'cym' 'wol' 'xho' 'yor' 'zul' 'zho_trad'
    )
  fi
